...
L = numpy.array([0.10, 0.16, 0.22, 0.28, 0.34, 0.40, 0.46, 0.52, 0.58, 0.64])
dL = numpy.array([0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01])
T = numpy.array([0.71, 0.76, 0.91, 1.00, 1.20, 1.14, 1.44, 1.40, 1.53, 1.58])
dT = numpy.array([0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05])
...
b0, b1 = est
db0 = numpy.sqrt(covar[0, 0])
db1 = numpy.sqrt(covar[1, 1])
g = 4*pi*pi/b1
dg = (g/b1)*db1
# Estimates of intercept and slope
# Standard error of intercept
# Standard error of slope
# Estimate for g (computed from b1)
# Estimate for standard error of g
