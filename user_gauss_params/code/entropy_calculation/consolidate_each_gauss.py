...
def server_consolidate(selected_users_set, gFea_subFolders, target_outerfolder):
    for subf in enumerate(gFea_subFolders):
        consolidated_params = {}
        the_fea_dir = subf
...
def unite_gauss(selected_users_set, gauss_folder_ID):
    individual_gauss = ["/home/code/entropy/user_gauss_params/data/users_individual_gauss/"+gauss_folder_ID+"/"] # location where stores individual gauss
    ...
    target_outerfolder = "/home/code/entropy/user_gauss_params/data/united_gauss/"+gauss_folder_ID+"/"
