...
t1 = time.time()
print("loading combined.csv takes ", t1-t0)
...
for values in dfTotalXI.iteritems():  # for each feature
    ...
    np.savetxt("/home/xphuang/entropy/user_gauss_params/data/combine/sums/" + str(featureID)+"_sum.csv", norm_summm, delimiter=",")
...
np.savetxt("/home/xphuang/entropy/user_gauss_params/data/combine/sums/benchmark_result_list.csv", result_list, delimiter=",")
