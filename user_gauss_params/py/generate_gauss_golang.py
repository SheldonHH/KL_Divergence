...
# gauss_result_frequency_path1 = 'data/gauss_result/gauss_result_frequency_1.csv'
# gauss_result_frequency_path2 = 'data/gauss_result/gauss_result_frequency_2.csv'
# w_the_user_params_json = 'data/gauss_result/user1_params.json'
# w_the_user_entropies_json = 'data/gauss_result/user1_entropies.json'
# w_the_user_entropies_sum_json = 'data/gauss_result/user1_entropies_sum.json'
