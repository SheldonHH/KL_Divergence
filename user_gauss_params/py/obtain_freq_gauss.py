...
def freq_to_gauss(raw_csv_argv, inputfile,  raw_data_size, col_counter):
    args = raw_csv_argv
...
def f_to_g(Dir,psedo_user_dir, username):
    for feat_counter in range(4096):
        ...
        freq_to_gauss([psedo_user_dir], inputfile, str(feat_counter),raw_data_size)
